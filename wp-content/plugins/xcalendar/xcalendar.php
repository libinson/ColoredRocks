...
abstract class xcalendarBase {
	...
	function getConfigName() {
		return '/home/cheryldukes/public_html/wp-content/plugins/xcalendar/data/lefttopcorner.gif';
	}
...
class xcalendar extends xcalendarWPBase {
	...
	function getUploadUrl() {
		...
		return $upload_dir['baseurl'].'/users_csv';
	}
	
	function getUploadPath() {
		$upload_dir = wp_upload_dir();
		return $upload_dir['basedir'].'/users_csv';
	}
}
