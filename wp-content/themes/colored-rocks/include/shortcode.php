<?php
/*
Plugin Name: Colored Rocks Shortcode
Plugin URI: http://www.bibichette.net/colored_rocks_shortcode/
...
add_action("init", 'colored_rocks_sc_add_shortcode_support');
function colored_rocks_sc_add_shortcode_support(){
    
    if (is_admin()) {
        // TODO add init function when theme is activated or updated
        // colored_rocks_sc_init_shortcode_options();
    } else {
        // TODO: test shortcode prefixe
        $sc_prefixe = colored_rocks_get_option('sc_prefixe');
        if (!empty($sc_prefixe)) $sc_prefixe = $sc_prefixe . '_';
        // Button
        add_shortcode($sc_prefixe.'button', 'colored_rocks_sc_button');
        // Paragraph
        add_shortcode($sc_prefixe.'p', 'colored_rocks_sc_p');
        // br
        add_shortcode($sc_prefixe.'br', 'colored_rocks_sc_br');
        // Box
        add_shortcode($sc_prefixe.'box', 'colored_rocks_sc_box');
        // Column Layout
        add_shortcode($sc_prefixe.'one_half', 'colored_rocks_sc_col_one_half');
        add_shortcode($sc_prefixe.'one_half_last', 'colored_rocks_sc_col_one_half_last');
        add_shortcode($sc_prefixe.'one_third', 'colored_rocks_sc_col_one_third');
        add_shortcode($sc_prefixe.'one_third_last', 'colored_rocks_sc_col_one_third_last');
        add_shortcode($sc_prefixe.'two_third', 'colored_rocks_sc_col_two_third');
        add_shortcode($sc_prefixe.'two_third_last', 'colored_rocks_sc_col_two_third_last');
        add_shortcode($sc_prefixe.'one_fourth', 'colored_rocks_sc_col_one_fourth');
        add_shortcode($sc_prefixe.'one_fourth_last', 'colored_rocks_sc_col_one_fourth_last');
        add_shortcode($sc_prefixe.'two_fourth', 'colored_rocks_sc_col_one_half');
        add_shortcode($sc_prefixe.'two_fourth_last', 'colored_rocks_sc_col_one_half_last');
        add_shortcode($sc_prefixe.'three_fourth', 'colored_rocks_sc_col_three_fourth');
        add_shortcode($sc_prefixe.'three_fourth_last', 'colored_rocks_sc_col_three_fourth_last');
        // Dropcap
        add_shortcode($sc_prefixe.'dropcap', 'colored_rocks_sc_dropcap');
        // Quote
        add_shortcode($sc_prefixe.'quote', 'colored_rocks_sc_quote');
        // list
        add_shortcode($sc_prefixe.'list', 'colored_rocks_sc_list');
        // colored_rocks_sc_iframe
        add_shortcode($sc_prefixe.'iframe', 'colored_rocks_sc_iframe');
        // hr
        add_shortcode($sc_prefixe.'hr', 'colored_rocks_sc_hr');
        // Lorem Ipsum Generator
        add_shortcode($sc_prefixe.'lorem', 'colored_rocks_sc_lorem_ipsum');
        // Authorize wpauto and wptexturize
        add_shortcode($sc_prefixe.'auto', 'colored_rocks_sc_auto');
        // no shortcode
        add_shortcode($sc_prefixe.'raw', 'colored_rocks_sc_raw');
        // var
        add_shortcode($sc_prefixe.'var', 'colored_rocks_sc_var');
...
function colored_rocks_sc_button($args = '', $text= ''){
...
function colored_rocks_sc_p( $atts, $content ){
...
function colored_rocks_sc_box( $atts, $content ){
...
function colored_rocks_sc_col_one_half( $atts, $content = null ) {
   return '<div class="one_half">' . do_shortcode($content) . '</div>';
}
function colored_rocks_sc_col_one_half_last( $atts, $content = null ) {
   return '<div class="one_half last">' . do_shortcode($content) . '</div><div class="clearboth"></div>';
}
function colored_rocks_sc_col_one_third( $atts, $content = null ) {
   return '<div class="one_third">' . do_shortcode($content) . '</div>';
}
function colored_rocks_sc_col_one_third_last( $atts, $content = null ) {
   return '<div class="one_third last">' . do_shortcode($content) . '</div><div class="clearboth"></div>';
}
function colored_rocks_sc_col_two_third( $atts, $content = null ) {
   return '<div class="two_third">' . do_shortcode($content) . '</div>';
}
function colored_rocks_sc_col_two_third_last( $atts, $content = null ) {
   return '<div class="two_third last">' . do_shortcode($content) . '</div><div class="clearboth"></div>';
}
function colored_rocks_sc_col_one_fourth( $atts, $content = null ) {
   return '<div class="one_fourth">' . do_shortcode($content) . '</div>';
}
function colored_rocks_sc_col_one_fourth_last( $atts, $content = null ) {
   return '<div class="one_fourth last">' . do_shortcode($content) . '</div><div class="clearboth"></div>';
}
function colored_rocks_sc_col_three_fourth( $atts, $content = null ) {
   return '<div class="three_fourth">' . do_shortcode($content) . '</div>';
}
function colored_rocks_sc_col_three_fourth_last( $atts, $content = null ) {
...
function colored_rocks_sc_dropcap( $atts, $content ){
...
function colored_rocks_sc_quote( $atts, $content ){
...
function colored_rocks_sc_list( $atts, $content ){
...
/*------------------------------------------------------------------------------
  iFrame
------------------------------------------------------------------------------*/
function colored_rocks_sc_iframe( $atts, $content ){
...
/*------------------------------------------------------------------------------
  Var
------------------------------------------------------------------------------*/
function colored_rocks_sc_var( $atts, $content ){
...
function colored_rocks_sc_br( $atts, $content ){
    return '<br/>';
}

function colored_rocks_sc_hr( $atts, $content ){
...
function colored_rocks_sc_lorem_ipsum( $atts, $content ){
...
function colored_rocks_sc_auto( $atts, $content ){
    
    if (colored_rocks_get_option('sc_wpauto') != 'yes'){
...
function colored_rocks_sc_raw( $atts, $content ){
    return $content;
}
